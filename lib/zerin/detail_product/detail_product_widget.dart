...
class _DetailProductWidgetState extends State<DetailProductWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CartProductRecord>(
      stream: CartProductRecord.getDocument(widget.detref!),
      builder: (context, snapshot) {
        ...
        final detailProductCartProductRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).secondaryBackground,
          appBar: AppBar(
              ...
              children: [
                Padding(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.network(
                      detailProductCartProductRecord.gambar,
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        detailProductCartProductRecord.nama,
                      ...
                      Text(
                        detailProductCartProductRecord.deskripsi,
                      ...
                      Padding(
                        ...
                        child: Text(
                          detailProductCartProductRecord.harga.toString(),
                          style:
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        FFAppState().addToCart(
                            detailProductCartProductRecord.reference);
                        setState(() {});
                        FFAppState().cartSum = FFAppState().cartSum +
                            detailProductCartProductRecord.harga.toDouble();
                        setState(() {});
                      },
                      text: 'Add to Cart',
